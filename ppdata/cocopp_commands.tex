...
\providecommand{\algCtables}{\StrLeft{WCA Sequential results}{\ntables}}
\providecommand{\algBtables}{\StrLeft{MBO Sequential results}{\ntables}}
\providecommand{\algAtables}{\StrLeft{PSO Sequential results}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
...
\providecommand{\algsfolder}{PSO_S_MBO_S_WCA_S_121319h3528/}
\providecommand{\algorithmA}{MBO Sequential results}
\providecommand{\algorithmB}{PSO Sequential results}
\providecommand{\algorithmC}{WCA Sequential results}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\algsfolder}{PSO_S_MBO_S_121317h0140/}
\providecommand{\algorithmA}{MBO Sequential results}
\providecommand{\algorithmB}{PSO Sequential results}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
